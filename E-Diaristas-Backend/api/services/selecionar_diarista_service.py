from api.services.diaria_service import (
    listar_diaria_id,
    calcular_indice_compatibilidade,
)
...
def selecionar_diarista_diaria(diaria_id):
    ...
    candidatar_diarista_diaria_service.contratar_diarista_diaria(
        diaria, candidatas[diarista].id
    )
