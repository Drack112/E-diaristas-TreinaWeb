...
from api.services.usuario_service import listar_usuario_id
from api.services.endereco_diarista_service import listar_endereco_diarista
...
def calcular_distancia_diaria_diarista(cep_diaria, cep_diarista):
    ...
    distancia = gmaps.distance_matrix(cep_formatado_diaria, cep_formatado_diarista)[
        "rows"
    ][0]["elements"][0]
