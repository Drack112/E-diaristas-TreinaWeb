...
urlpatterns = [
    path(
        "diaristas/localidades",
        diaristas_localidade_view.DiaristasLocalidades.as_view(),
        name="diaristas-localidades-list",
    ),
    path(
        "enderecos", endereco_cep_view.EnderecoCep.as_view(), name="endereco-cep-list"
    ),
    path(
        "diaristas/disponibilidade",
