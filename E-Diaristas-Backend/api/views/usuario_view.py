...
from api.serializers import usuario_serializer, editar_usuario_serializer
from api.permissions import editar_usuario_permission
from api.models import Usuario as UsuarioModel


class Usuario(APIView):
    permission_classes = [
        editar_usuario_permission.EditarUsuarioPermission,
    ]
    ...
    def post(self, request, format=None):
        ...
        return Response(
            serializer_usuario.errors, status=status_http.HTTP_400_BAD_REQUEST
        )
