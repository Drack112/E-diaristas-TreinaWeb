...
from api.serializers import diaria_serializer
from api.services.diaria_service import listar_diarias_usuario, listar_diaria_id
...
class Diaria(APIView):
    ...
    def get(self, request, format=None):
        ...
        serializer_diaria = diaria_serializer.DiariaSerializer(
            diarias, many=True, context={"request": request}
        )
    ...
    def post(self, request, format=None):
        ...
        return Response(
            serializer_diaria.errors, status=status_http.HTTP_400_BAD_REQUEST
        )
...
class DiariaID(APIView):
    ...
    def get(self, request, diaria_id, format=None):
        ...
        serializer_diaria = diaria_serializer.DiariaSerializer(
            diaria, context={"request": request}
        )
        return Response(serializer_diaria.data, status=status_http.HTTP_200_OK)
