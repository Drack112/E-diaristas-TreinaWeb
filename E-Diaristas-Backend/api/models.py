...
from api.managers import diarista_manager, diaria_manager, avaliacao_manager
...
class Usuario(AbstractUser):
    ...
    foto_documento = models.ImageField(
        null=True,
        upload_to=nome_arquivo_documento,
        validators=[
...
class Pagamento(models.Model):
    ...
    diaria = models.ForeignKey(
        Diaria, null=False, blank=False, on_delete=models.DO_NOTHING
    )
    created_at = models.DateTimeField(auto_now_add=True, null=True)
    updated_at = models.DateTimeField(auto_now=True, null=True)
